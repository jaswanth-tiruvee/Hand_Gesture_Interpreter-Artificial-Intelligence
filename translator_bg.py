...
window_name = "AI Driven Hand Gesture Recognition"
...
model = load_model("bglessmodelv1.h5")
...
def withSkinSegment():
    ...
    while True:
        ...
        bgremoved = cv2.bitwise_and(img1, img1, mask = mask)
        ...
        cv2.imshow("bgremoved", bgremoved)
        hand_bg_rm = bgremoved[y_start: y_end, x_start: x_end]
